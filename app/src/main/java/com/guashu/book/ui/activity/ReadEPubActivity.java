...
import com.guashu.book.ui.adapter.EPubReaderAdapter;
import com.guashu.book.ui.adapter.TocListAdapter;
import com.guashu.book.utils.FileUtils;
import com.guashu.book.view.epubview.DirectionalViewpager;
import com.guashu.book.view.epubview.ReaderCallback;
...
public class ReadEPubActivity extends BaseActivity implements ReaderCallback {
    ...
    private void initPager() {
        viewpager.setOnPageChangeListener(new DirectionalViewpager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                mTocListAdapter.setCurrentChapter(mChapterListBackup.get(position));
            }
    ...
    private void initTocList() {
        mTocListAdapter = new TocListAdapter(this, mChapterListBackup, "", mChapterListBackup.get(0));
    ...
    private void setSpineReferenceTitle() {
        ...
        for (int i = 0; i < trSize; i++) {
            ...
            if (resource != null) {
                mChapterList.add(new BookMixAToc.mixToc.Chapters(resource.getTitle(), resource.getHref(), i + 1));
                mChapterListBackup.add(new BookMixAToc.mixToc.Chapters(resource.getTitle(), resource.getHref(), i + 1));
            }
        }
    }
