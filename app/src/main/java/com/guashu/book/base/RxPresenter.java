...
public class RxPresenter<T extends BaseContract.BaseView> implements BaseContract.BasePresenter<T> {
    protected BookApiManager bookApiManager = BookApiManager.getInstance();
    ...
    public IBookApi getBookApi(BookSource source) {
        return bookApiManager.getAllBookApi().get(source);
    }
}
