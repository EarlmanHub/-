 ...
 * @author user
 */
public class KuWenApi implements IBookApi {
    private static final BookSource BOOK_SOURCE = BookSource.KUWEN;
    ...
    public List<SearchDetail.SearchBooks> searchBooKFuzzy(String name) {
        ...
        String url = "http://zhannei.baidu.com/cse/search?s=7121935581096544130&q="
                + name;
        try {
    ...
    public List<BookMixAToc.mixToc.Chapters> getChapterList(String bookUrl) {
        ...
        try {
            ...
            for (int i = 0; i < select.size(); i++) {
                ...
                chapters.link = "http://www.kuwen.net"
    ...
    public ChapterRead.Chapter getChapterRead(String chapterUrl) {
        try {
            ...
            String text = document.select(".con_top").text();
            String[] split1 = text.split(" > ");
            String title = split1[3];
