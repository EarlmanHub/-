 ...
 * 八一中文网
 * <p>
 * BaYi("www.zwdu.com", "八一中文网", true);
 */
public class BaYi implements IBookApi {
    private static final BookSource BOOK_SOURCE = BookSource.BAYI;
    ...
    public List<SearchDetail.SearchBooks> searchBooKFuzzy(String name) {
        ...
        String url = "http://zhannei.baidu.com/cse/search?s=15390153038627446418&q="
                + name;
        try {
    ...
    public List<BookMixAToc.mixToc.Chapters> getChapterList(String bookUrl) {
        ...
        try {
            ...
            for (int i = 0; i < select.size(); i++) {
                ...
                chapter.link = "http://www.zwdu.com/"
